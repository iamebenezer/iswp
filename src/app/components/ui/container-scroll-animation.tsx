...
export const Card = ({
  ...
  return (
    ...
    >
      <div className="bg-black h-full w-full rounded-2xl grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 overflow-hidden p-4">
        {users.map((user, idx: number) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <h2 className=" text-white font-sub text-xs ">{user.designation}</h2>
            </div>
          </motion.div>
        ))}
      </div>
